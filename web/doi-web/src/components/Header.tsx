				...
				<div className="flex flex-wrap items-center justify-between mx-auto p-4 bg-EBE9F7">
					...
					{isDropdownOpen && (
						<div className="w-full md:block md:w-auto" id="navbar-default">
							<ul className="font-medium flex flex-col p-4 md:p-0 mt-4 ml-4 border border-gray-100 rounded-lg lg:flex-row lg:space-x-8 rtl:space-x-reverse lg:mt-0 lg:border-0 items-center">
